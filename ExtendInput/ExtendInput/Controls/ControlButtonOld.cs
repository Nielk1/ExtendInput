...
namespace ExtendInput.Controls
{
    ...
    public class ControlButtonOld : IControl
    {
        ...
        public ControlButtonOld(ButtonProperties Properties)
        {
        ...
        public object Clone()
        {
            ControlButtonOld newData = new ControlButtonOld(this.Properties);
